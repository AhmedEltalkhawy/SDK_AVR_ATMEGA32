...
void PWM_Freq_KHZ(u16 freq)
{
	...
	{
		u16 Ttotal=1000/freq; /* pulse_f = timer_f / total = pulse in k = 1000000 / total */
		if (Ttotal>=1)
		{
			ICR1=Ttotal-1;
		}
...
{
	Timer1_Init(TIMER1_CTC_OCRA_TOP_MODE,TIMER1_SCALER_8 ,OCRA_DISCONNECTED ,OCRB_DISCONNECTED); // error here 
	OCR1A=999;
